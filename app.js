...
const WEEKLY = [
  ...
  ['bq', '블러디퀸',       [['카오스', 407]]],
  ['vl', '벨룸',         [['카오스', 464]]],
  ['su', '스우',         [['노멀', 835], ['하드', 4890], ['익스트림', 54500]]],
  ['dm', '데미안',        [['노멀', 875], ['하드', 4640]]],
  ['slm', '가디언 엔젤 슬라임', [['노멀', 1270], ['카오스', 7130]]],
  ['lu', '루시드',        [['이지', 1490], ['노멀', 1780], ['하드', 5970]]],
  ['wl', '윌',          [['이지', 1610], ['노멀', 2050], ['하드', 7320]]],
  ['dk', '더스크',        [['노멀', 2200], ['카오스', 6630]]],
  ['jh', '진 힐라',       [['노멀', 6760], ['하드', 10000]]],
  ['du', '듄켈',         [['노멀', 2370], ['하드', 8960]]],
  ['sr', '선택받은 세렌',    [['노멀', 16700], ['하드', 30200], ['익스트림', 184000]]],
  ['kl', '감시자 칼로스',    [['이지', 23800], ['노멀', 47900], ['카오스', 123000], ['익스트림', 410400]]],
  ['ad', '최초의 대적자',    [['이지', 26100], ['노멀', 53200], ['하드', 139000], ['익스트림', 471200]]],
  ['kr', '카링',         [['이지', 32000], ['노멀', 59300], ['하드', 156000], ['익스트림', 538700]]],
  ['hs', '찬란한 흉성',     [['노멀', 57600], ['하드', 267800]]],
  ['bl', '벨로나',        [['이지', 39600], ['노멀', 82400], ['하드', 295000]]],
  ['lb', '림보',         [['노멀', 99500], ['하드', 238500]]],
  ['bd', '발드릭스',       [['노멀', 132000], ['하드', 307800]]],
  ['jp', '유피테르',       [['노멀', 156000], ['하드', 484500]]]
];
const MONTHLY = [
  ['bm', '검은 마법사', [['하드', 46500], ['익스트림', 568000]], true]
];
